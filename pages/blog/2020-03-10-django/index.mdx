...
export const description = `Django serves the back-end for a ReactJS based front-end project. I needed to learn a few things about it to get the back-end running so I can dig into the front-end.

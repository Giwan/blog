...
export const description = `The pagination component created in another post will be published on NPM. 
It allows others to use the component in their React projects.`;

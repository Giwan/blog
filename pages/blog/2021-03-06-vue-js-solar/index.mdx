...
export const description = `Not having worked very much with VueJS, 
this is a simple app that goes through the basics. 
It covers architecture and the way information is shared between components.`; 
...
<a href="https://github.com/Giwan/vue-solar-system" target="_blank" rel="noopener">GitHub.com/Giwan/vue-solar-system</a>

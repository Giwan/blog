...
export const description = `Web crawlers can't parse JS which means that Single Page Applications need to render on the server if they want to be indexed by the search engines.`;

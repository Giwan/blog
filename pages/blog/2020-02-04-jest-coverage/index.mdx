...
export const description = `Configure Jest coverage in Create React App. 
Coverage indicates how much of the code is tested. 
A higher than 80% coverage is a decent indicator that the code is working as expected. `;

export const meta = {
    title: "Jest coverage in Creact React App",
    description,
...
Creat a project with <a href="https://create-react-app.dev/" target="_blank">Create-React-App</a> and <a href="https://jestjs.io/" target="_blank">jest</a> is already included.
...
The `--coverage --color` flag shows the coverage report in color.

...
The `preload` file helps to channel information between the **insecure** browserWindow and the electron app that has access to NodeJS.

To avoid a reference errror, create the `preload.js` file with `touch preload.js`.

...
export const description = `A short article on how debugging works with visual studio code. It's especially useful when debugging server side projects like NodeJS. VSCode has this nifty feature that allows breakpoints to be set in the editor while building the front-end in the chrome browser.`;

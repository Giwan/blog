...
export const description = `A small demo project to work on Svelte. Svelte is a UI Framework, like ReactJS or ViewJS. However it takes a different approach by acting as a compiler.`;

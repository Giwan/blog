...
export const description = `How to create and host a static site, including SSL and domain name for 0 euros! Static sites can be hosted for free thanks to some amazing services available as of 2018.`;
